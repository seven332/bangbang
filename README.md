...
- complete interrupt delivery, configured guest execution, continuous vCPU run loops, virtqueue walking, feature negotiation, device-backed MMIO loops, real device emulation, public startup wiring, multi-vCPU setup, or PSCI behavior
