...
- interrupt injection, configured guest execution, continuous vCPU run loops, HVF guest register completion for MMIO exits, real device emulation, public startup wiring, multi-vCPU setup, or PSCI behavior
