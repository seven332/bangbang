...
- complete interrupt delivery, configured guest execution, continuous vCPU run loops, queue notification/completion dispatch, device-backed feature negotiation and activation, indirect descriptors, device-backed MMIO loops, real device emulation, public startup wiring, multi-vCPU setup, or PSCI behavior
