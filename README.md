...
- complete interrupt delivery, configured guest execution, continuous vCPU run loops, avail/used virtqueue ring handling, queue notification/completion, feature negotiation, indirect descriptors, device-backed MMIO loops, real device emulation, public startup wiring, multi-vCPU setup, or PSCI behavior
