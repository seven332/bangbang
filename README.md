...
- interrupt injection, configured guest execution, continuous vCPU run loops, automatic MMIO exit resolution/dispatch from the runner, real device emulation, public startup wiring, multi-vCPU setup, or PSCI behavior
