...
debug-control, translation, and thread-context system-register subsets,
...
create/load, restore, a persistent schema, watchpoint and debug-trap state,
remaining vCPU state, EL2
