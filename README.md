...
- complete interrupt delivery, configured guest execution, continuous vCPU run loops, device-backed MMIO loops, real device emulation, public startup wiring, multi-vCPU setup, or PSCI behavior
