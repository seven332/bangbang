...
- complete interrupt delivery, including timer PPI delivery, public configured guest execution, unbounded or public continuous vCPU run loops, public startup, HVF runner-loop notification scheduling or serial output, serial/backend interrupt wiring beyond the internal boot block notification path, device-backed feature negotiation, indirect descriptors, device-backed MMIO loops, complete device emulation, multi-vCPU setup, or PSCI behavior
