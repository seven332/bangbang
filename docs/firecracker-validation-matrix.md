...
| --- | --- | --- | --- | --- |
| Native-v2 state, File/COW memory, artifact transaction, public process lifecycle, and focused reconstruction | current 2.9 complete-serial multi-vCPU Full/File lifecycle with independently optional profile-3 storage, entropy, and balloon implemented and verified; exact 2.3–2.8 and frozen native-v1 remain readable | unit, fixed binary fixtures, hostile component/registry/device/FDT/balloon mutations, artifact fault/authority checks, API/process family routing, typed complete-product restore-stage injection, signed HVF, signed direct MMIO/PCI executable, signed App Sandbox and production bundle, docs | #1490, #1525, #1526, #1528, #1529, #1566, #1567, #1568, #1569, #1575, #1576, #1577, #1578, #1583, #1584, #1585, #1586, #1587, #1588, #1589, #1616, #1617, #1634, #1651, #1652, #1665, #1666, #1680, #1681 | The current writer emits `2.9.0` with required serial kind 8 and independently optional device-graph kind 7 profile 3, entropy kind 9, and balloon kind 10 after the memory/machine/global/topology/vCPU/time graph, admitting all eight optional-product combinations over coherent MMIO or PCI. Kind 10 retains exact configuration/features, two through five active queue cursors, one pending statistics descriptor, latest optional statistics, DONE-normalized hint history, common virtio/transport state, and canonical host-side inflated-PFN accounting. It is capped at 262,144 ranges and 4 MiB inside the 16-MiB state-file cap. Restore validates every 4-KiB guest PFN against adopted RAM and creates fresh memory bindings, timer, metrics, reclaim adviser, notifier/interrupt/dispatcher, endpoint, process clock, and cleanup ownership. A retained descriptor waits one full destination-local interval after resume and never advances while Paused; a destination starts new hint runs after the captured run is normalized to DONE. Signed direct and normal-production/App-Sandbox MMIO/PCI evidence proves storage/entropy/balloon products, UART/entropy/balloon continuation, post-restore inflate/deflate/API/reporting, recapture, immutable independent clones, fresh metrics, malformed/cancellation/death cleanup, containment, and explicit/automatic resume. Darwin discard aligns/coalesces to destination host pages, normally 16 KiB, but remains best effort and makes no synchronous RSS promise. CRCs cover state/metadata only; external backing authentication/encryption and operator serialization remain required. Virtio-mem, network, and vsock serialization, native-v2 Uffd, Diff/merge, overrides/editing, Firecracker bytes, and broad portability remain Wave 6 work. |
| Direct pmem mapping, root boot, and native-v2 restore | implemented and verified for startup MMIO/PCI, non-root runtime PCI, complete capture-ready live state, exact native-v2 2.6 through current 2.9 profile-3 serialization/restore | unit, process e2e, signed HVF capture equality, focused profile-3 fault/authority tests, signed executable storage matrix, signed normal-production bundle storage matrix, docs, pinned-source compare | #1439, #1444, #1448, #1471, #1634, #1651, #1652, #1665, #1666, #1680, #1681 | One reference-counted file/private-tail mapping is registered directly with HVF. Writable file prefixes use a shared host mapping; read-only guest mappings use a private write-capable host view required by HVF while guest permissions stay read-only. Flush synchronizes exactly the nonzero file prefix with `MS_SYNC`; the aligned tail is volatile. Profile 3 binds exact file/mapped geometry and restores direct paths or exact `PmemBacking` grants with the complete block/pmem batch; current 2.9 composes that unchanged storage graph with required serial and optional entropy/balloon. Signed rooted pmem-only and rootless mixed MMIO/PCI cells prove shared writable prefix epochs, unchanged read-only peers, a zero DAX private tail on every fresh mapping, limiter/retry and interrupt continuation, recapture, immutable state/memory, pathname-replacement resistance, and cleanup. Pmem remains outside ordinary RAM dirty epochs, and both checked pmem composite records are terminal. |
...
| Capability inventory enforcement | structural inventory implemented; capability audit in progress | unit, workspace CI, docs, pinned-source compare | #1348, #1349, #1527, #1546, #1547, #1548, #1549, #1550, #1551, #1552, #1553, #1554, #1555, #1578, #1589, #1616, #1617, #1634, #1651, #1652, #1665, #1666, #1680, #1681 | The machine-owned v1.16.0 source manifest and human overlay keep every disposition mechanically checked. Native-v2 progressed through exact 2.3–2.8, promoting the pmem, serial, and entropy aggregates after matching signed gates. #1680 activates current 2.9 with optional balloon kind 10 across all eight products; #1681 promotes exactly `corpus:ballooning` and `semantic.memory-device:balloon-oom-stats-hinting-and-reporting` after signed direct and contained MMIO/PCI continuation. The resulting disposition counts are 240/158/3/17. Other snapshot corpora and API/schema aggregates remain under audit for Diff, optional devices other than pmem/serial/entropy/balloon/MMDS, tools, Firecracker interoperability, and portability. |
...
| Product PCI and modern virtio-pci | all-virtio startup, aggregate runtime hotplug/live storage certification, and current native-v2 2.9 block/pmem/serial plus optional entropy and balloon persistence, with vsock capture-ready ownership implemented; other optional-device persistence/restore deferred | unit, process e2e, signed HVF capture/equality/reconstruction, signed executable aggregate plus storage/serial/entropy/balloon restore, signed production bundle aggregate plus storage/serial/entropy/balloon restore, docs, pinned-source compare | #1416, #1417, #1418, #1419, #1420, #1421, #1422, #1423, #1444, #1448, #1471, #1475, #1516, #1583, #1584, #1585, #1586, #1587, #1588, #1589, #1616, #1617, #1634, #1651, #1652, #1665, #1666, #1680, #1681 | The supported macOS arm64/HVF product path selects one immutable all-virtio transport after target/GIC-MSI and exact 31-endpoint capacity preflight. Exact 2.6 profile 3 persists block/pmem PCI state, exact 2.7 adds required platform-MMIO serial, exact 2.8 may add entropy, and current 2.9 may add balloon first in canonical PCI slot/route order. Kind 10 retains variable queue/common-virtio/BAR/capability/MSI-X/interrupt/registry state and reconstructs fresh notifier, interrupt, dispatcher, timer, metrics, reclaim, endpoint, and cleanup owners. Signed direct and normal-production matrices prove active storage I/O, serial/entropy/balloon continuation, fresh ownership, destination-local polling, external prefix epochs, fresh pmem private tails, recapture, immutable clone isolation, and cleanup. Automatic guest hotplug notification, persistence for optional devices other than pmem, entropy, and balloon, external vmnet certification, and KVM ITS identity remain deferred. |
...
| Snapshots and restore | current public native-v2 2.9 complete-serial Full/File multi-vCPU lifecycle with independently optional profile-3 storage, entropy, and balloon implemented and verified; exact 2.3–2.8 and frozen native-v1 File/Uffd readers retained | unit, API socket, process e2e, signed HVF capture/reconstruction, typed complete-product resource/failure injection, signed direct and normal-production MMIO/PCI matrices, signed App Sandbox restore, docs | #543, #1263, #1264, #1390, #1395, #1396, #1441, #1525, #1526, #1528, #1529, #1554, #1575, #1576, #1577, #1578, #1583, #1584, #1585, #1586, #1587, #1588, #1589, #1609, #1610, #1611, #1612, #1613, #1614, #1615, #1616, #1617, #1634, #1651, #1652, #1665, #1666, #1680, #1681 | Public create admits Paused Full sources with 1–32 vCPUs, required serial, optional matching-transport profile-3 storage, entropy, and balloon, and no virtio-mem/network/vsock/MMDS/boot timer; it publishes current `2.9.0` memory first and state last. Kind 10 is a bounded 4-MiB optional component with at most 262,144 canonical 4-KiB PFN ranges inside the 16-MiB state cap. Load authorizes exact external resources and constructs fresh serial, entropy, and balloon owners without fallback or override before Paused publication. Signed direct and normal-production/App-Sandbox MMIO/PCI evidence proves latest and pending balloon statistics, a full destination-local interval, DONE then new hinting, reporting, inflate/deflate/API accounting, fresh metrics, recapture, immutable independent clones, malformed/cancellation/death cleanup, and containment alongside existing serial/entropy/storage continuation. Guest PFNs remain 4 KiB even when Darwin host pages are normally 16 KiB; discard is best effort without synchronous RSS assurance. The format remains bangbang-native and unauthenticated. Diff, native-v2 Uffd, optional devices other than serial, pmem, entropy, and balloon, Firecracker artifacts, and broad portability remain unsupported or under audit. |
...
| Remaining Firecracker devices | implemented supported subsets; transport and profile limits explicit | unit, api socket, process e2e, signed HVF, signed executable, signed production bundle, docs | #544, #797, #800, #802, #804, #806, #808, #810, #812, #814, #815, #818, #869, #873, #875, #877, #888, #890, #892, #894, #896, #898, #900, #902, #904, #905, #908, #910, #912, #914, #920, #922, #926, #928, #930, #932, #934, #936, #938, #940, #960, #962, #964, #968, #970, #972, #988, #990, #1000, #1002, #1016, #1018, #1024, #1329, #1328, #1330, #1331, #1335, #1336, #1337, #1338, #1362, #1418, #1419, #1420, #1421, #1422, #1444, #1473, #1474, #1475, #1477, #1478, #1479, #1480, #1529, #1634, #1651, #1652, #1665, #1666, #1680, #1681 | Balloon, virtio-mem, entropy, serial, network, vsock, RTC, VMGenID, VMClock, and PVTime retain their documented live/capture-ready subsets and explicit artifact handoffs. Serial implements exact native-v2 2.7 restore, pmem implements profile 3 from exact 2.6 through current 2.9, entropy implements optional exact 2.8 through current 2.9, and balloon implements optional exact 2.9 kind 10 over MMIO/PCI. Balloon restoration retains exact queue/statistics/hint/accounting/transport state while reconstructing fresh destination ownership; signed direct and contained guests certify Paused/automatic continuation, full-interval pending statistics, DONE then fresh hinting, reporting, inflate/deflate/API behavior, clones, failures, and cleanup. Serialization/restore for optional devices other than serial, pmem, entropy, and balloon, automatic guest hotplug notification, and externally certified vmnet connectivity remain explicit limits. |
...
| Public native-v2 Full/File endpoint activation | implemented current 2.9 complete-serial subset with independently optional regular-file block/pmem profile-3 storage, entropy, and balloon, plus exact native-v2 2.3–2.8 and frozen native-v1 readers | runtime, API socket, process lifecycle, signed direct executable and normal-production/App-Sandbox matrices, docs | #543, #1276, #1396, #1575, #1576, #1577, #1578, #1589, #1616, #1617, #1634, #1651, #1652, #1665, #1666, #1680, #1681 | Public Full create emits exact native-v2 2.9 with required complete serial state and all eight optional storage/entropy/balloon products on one transport. Public load classifies one opened state and selects frozen native-v1 or exact 2.3–2.9 File/COW, performs one exact storage-and-serial authority transaction, and constructs fresh entropy and balloon owners when present. There is no ambient fallback or load-time override. Repeated destinations share only externally managed writable block/pmem prefixes; state/memory and File/COW RAM remain immutable/private. Focused public complete-product and signed HVF owner matrices cover balloon-only-relative-to-serial, balloon plus storage, balloon plus entropy, and all-three optional products over MMIO/PCI. Signed direct and normal-production/App-Sandbox storage-plus-balloon matrices prove exact grants, recapture, explicit/automatic resume, destination-local polling and metrics, clone isolation, finite retryable/terminal failures, and death cleanup. |
...
production boundaries. #1680 activates current exact 2.9 with optional balloon,
and #1681 certifies the direct and contained restored-guest continuation,
limits, clone isolation, failure, and cleanup contract.
...
seven entropy, six serial, and one time/identity): 82 are terminal and three
...
except where the exact 2.7 serial, exact 2.8 entropy, and current 2.9 balloon
contracts now supply public encoding and restored-guest evidence. Wave 7 #1491
owns no record in this selector, and
...
normal-production certification. #1680 activates current exact 2.9, and #1681
promotes the two balloon aggregate records after matching signed certification,
so the current inventory is 240/158/3/17.
