...
order and bytes, every getter failure and retry, bounded accessors, thirty-way
...
accessors, thirty-way admission, abandonment, channel, panic, and cleanup.
...
backend failure and retry, raw accessors, thirty-way admission,
...
backend failure and retry, fixed-size access, thirty-way admission,
abandonment, channel, panic, and cleanup. Signed HVF coverage accepts only
documented unavailability/inactivity or two complete idle-vCPU captures without
...
exact ordering, owner-thread dispatch, thirty-way conflicts,
...
thirty-way conflicts, abandonment, channels, queued destruction, unwind,
...
full retry, exact ordering, owner-thread dispatch, thirty-way conflicts,
abandonment, channels, queued destruction, unwind, panic, shutdown, and both
...
owner-thread dispatch, thirty-way conflicts, abandonment, channels,
...
and full retry, exact ordering, owner-thread dispatch, thirty-way
