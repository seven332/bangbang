...
| Capability inventory enforcement | structural inventory implemented; capability audit in progress (164 implemented, 234 audit, 3 feasible-missing, 17 proven impossible) | unit, workspace CI, docs, pinned-source compare | #1348, #1349, #1420, #1421, #1422, #1423, #1444, #1445, #1446, #1447, #1448, #1449, #1461, #1462, #1471, #1473 | The machine-owned v1.16.0 source manifest records exact 26/38/44/152 Swagger identities, 23 configured executable arguments, three non-Swagger DELETE routes, public-tool operations/arguments, and an explicit source corpus. A separate human overlay owns every disposition and adds cross-leaf semantic records. Delivery validation permits honest `audit-required`/missing work; final mode rejects it. The 17 terminal exclusions cover strict runtime seccomp/jailer, exact Linux hugetlbfs `2M`, and narrow KVM/static CPU categories. #1420-#1423 promote runtime device hotplug; #1444-#1449 cover direct pmem, vhost, portable Async, and capture-ready storage; #1461/#1462 close block-special and vhost/virtio-mem delivery; #1471 promotes 28 directly owned storage records; and #1473 promotes 50 directly owned balloon records. The checked storage ledger leaves two named Wave 6 optional-pmem composites nonterminal; the checked balloon ledger likewise leaves exactly its balloon corpus and semantic aggregate with Wave 6 encoding and restore. Snapshot, vmnet, observability, tool, and final export owners otherwise remain nonterminal. |
