...
| --- | --- | --- | --- | --- |
| Native-v2 state, File/COW memory, artifact transaction, public process lifecycle, and focused reconstruction | current 2.5 regular-file multi-block multi-vCPU Full/File lifecycle implemented and verified; exact single-root 2.4, device-free 2.3, and frozen native-v1 remain readable | unit, fixed binary fixtures, hostile component/registry/device/FDT mutations, artifact fault/authority checks, API/process family routing, complete-set drive authority and restore-stage fault injection, signed three-vCPU HVF, signed public rooted/rootless MMIO/PCI executable, signed App Sandbox and production bundle, docs | #1490, #1525, #1526, #1528, #1529, #1566, #1567, #1568, #1569, #1575, #1576, #1577, #1578, #1583, #1584, #1585, #1586, #1587, #1588, #1589, #1616, #1617 | The immutable `2.0.0`, memory-only `2.1.x`, and base-platform `2.2.x` states remain structurally readable; exact `2.3.0` remains the runnable legacy device-free platform and exact `2.4.0` retains profile 1's singleton read-only root. The current writer emits `2.5.0` with device-graph kind 7 profile 2 after the memory/machine/global/topology/vCPU/time graph. Exact state-bound memory metadata validates before retained read-only private File/COW mappings. The public producer admits only Paused Full sources with configured boot metadata, 1–32 vCPUs, and 1–64 ordered regular-file block records over matching MMIO or the product PCI budget. A graph may be rootless or have one first root and may mix read-only/read-write, Sync/Async, Unsafe/Writeback, partuuid, and limiter state; optional devices/MMDS/boot timer, nondefault serial, and noncanonical UART remain rejected. Public load opens and decodes state once, routes current 2.5 to File/COW plus one exact keyed complete-set drive transaction, exact 2.4 to its singleton authority profile, legacy 2.3 to the platform loader, frozen native-v1 to File/Uffd, and pinned Firecracker or unknown bytes to explicit incompatibility. It has no ambient pathname fallback or per-drive override. Every process-restorable family publishes Paused before optional resume. Signed direct and normal-bundle evidence proves rooted/rootless MMIO/PCI reconstruction, all-drive pre/post-capture persistence and interrupts, limiter progress, recapture, fresh process/metrics/Async ownership, immutable state/memory, deliberate shared writable external backings, retained descriptor identity, worker/launcher death cleanup, and explicit/automatic resume. CRCs cover state/metadata only; external backing authentication/encryption and operator serialization are required. Optional devices/general serial state, native-v2 Uffd, Diff/merge, overrides/editing, Firecracker bytes, and broad portability remain Wave 6 work. |
...
| Capability inventory enforcement | structural inventory implemented; capability audit in progress | unit, workspace CI, docs, pinned-source compare | #1348, #1349, #1527, #1546, #1547, #1548, #1549, #1550, #1551, #1552, #1553, #1554, #1555, #1578, #1589, #1616, #1617 | The machine-owned v1.16.0 source manifest and human overlay keep every disposition mechanically checked. #1578 promoted the snapshot-version argument, complete instance/version-output semantic, aggregate run operation, and minimal Full create/load public-lifecycle semantic. #1589 advanced that terminal lifecycle to exact 2.4 singleton-root MMIO/PCI artifacts; #1616 and #1617 advance the same terminal records to current 2.5 rooted/rootless regular-file multi-block artifacts without promoting broad snapshot records. Snapshot corpora and API/schema aggregates remain under audit for Diff, optional devices/MMDS, tools, Firecracker interoperability, and portability. |
...
| Process CLI and API socket | 25 of 29 inventory records implemented and verified; two proven platform impossible; only two broad source corpora remain under audit | unit, API socket, process e2e, signed process, signed App Sandbox process, signed production bundle, pinned-source compare | #536, #545, #1008, #1010, #1048, #1058, #1060, #1070, #1092, #1260, #1302, #1352, #1365, #1368, #1384, #1419, #1578, #1589, #1616, #1617 | The checked 23-argument contract has 21 implemented leaves and two terminal seccomp platform exclusions. It covers argument precedence, Unicode identity, limits, readiness, fd-table behavior, signals including nonfatal SIGPIPE, socket ownership/cleanup, configuration startup, PCI, and current native snapshot output. `--snapshot-version` prints `v2.5.0`; bounded direct or exact-granted description reports the actual validated native-v1 or native-v2 version and explicitly rejects Firecracker bytes. The complete instance/version-output semantic and aggregate run operation are terminal. Only broad `corpus:design` and `corpus:getting-started` remain under audit for unrelated repository-wide claims. |
...
| Snapshots and restore | current public native-v2 2.5 regular-file multi-block Full/File multi-vCPU lifecycle implemented and verified; exact singleton-root 2.4, device-free 2.3, and frozen native-v1 File/Uffd readers retained | unit, API socket, process e2e, signed HVF capture/reconstruction, complete-set resource/failure injection, signed direct rooted/rootless MMIO/PCI executable, signed App Sandbox and normal production-bundle restore, docs | #543, #1263, #1264, #1390, #1395, #1396, #1441, #1525, #1526, #1528, #1529, #1554, #1575, #1576, #1577, #1578, #1583, #1584, #1585, #1586, #1587, #1588, #1589, #1609, #1610, #1611, #1612, #1613, #1614, #1615, #1616, #1617 | Public create admits only Paused Full sources with 1–32 vCPUs, configured boot metadata, a rooted or rootless ordered vector of 1–64 regular-file block devices over matching MMIO or the product PCI budget, no optional devices/MMDS/boot timer, and canonical default UART state; it publishes current `2.5.0` memory first and graph-bearing state last. Public load requires a pristine destination except logger/metrics, opens/decodes state once, retains native-v2 read-only File/COW memory, derives and atomically authorizes the exact keyed complete drive vector without fallback/override, commits that batch with the Paused owner, preserves exact singleton-root 2.4 and device-free 2.3 loading, and preserves frozen native-v1 eager File or macOS pager behavior. Every family validates before construction, commits Paused, and optionally resumes normally; only proven-pristine preconstruction failure with complete cleanup retries, while committed identity/time/resources, publication, incomplete cleanup, or resume failure is terminal. Signed direct and normal-production evidence proves rooted/rootless MMIO/PCI all-drive pre/post-capture persistence, limiter/interrupt progress, recapture, fresh VM/metrics/Async ownership, retained descriptors, immutable state/memory, deliberate shared writable external bytes, explicit/automatic resume, and worker/launcher death cleanup. The format remains bangbang-native and unauthenticated. Diff, native-v2 Uffd, Linux UFFD compatibility, overrides/editing, optional devices/general serial, Firecracker artifacts, and broad portability remain unsupported or under audit. |
...
| Public native-v2 Full/File endpoint activation | implemented current 2.5 regular-file profile-2 subset with exact native-v2 2.4/2.3 and frozen native-v1 readers | runtime, API socket, process lifecycle, signed direct executable, signed App Sandbox, signed production bundle, docs | #543, #1276, #1396, #1575, #1576, #1577, #1578, #1589, #1616, #1617 | Public Full create emits graph-required native-v2 2.5 for a rooted or rootless ordered vector of 1–64 regular-file block devices over MMIO or the product PCI budget, with mixed access, engine, cache, partuuid, limiter, queue, and retry state. Public load classifies one opened state and selects frozen native-v1 File/Uffd, legacy device-free native-v2 2.3 File/COW, exact singleton-root 2.4 File/COW, or current profile-2 2.5 File/COW plus one exact keyed complete-set backing transaction. There is no ambient path fallback, load-time drive override, or writable-backing COW: repeated destinations share externally managed writable bytes and require operator serialization. Paused-before-resume, dirty tracking, exact graph/transport reconstruction, active all-drive persistence and interrupts, metrics/latency, redaction, collision/cancellation, immutable state/memory, retained descriptors/grants, explicit/automatic resume, finite retryable/terminal failure stages, worker/launcher death cleanup, and exact version/description output are covered. |
...
#1616 and #1617 extend the macOS containment row's snapshot claim without
widening ambient authority: current native-v2 2.5 atomically adopts
state/memory and resolves every inert profile-2 selector through one exact
keyed destination drive transaction. Missing, extra, reordered, aliased,
wrong-access, wrong-role/kind, wrong-size, changed-geometry, or consumed
authority rejects before construction without pathname fallback. The complete
drive batch commits only with Paused session/controller publication; signed
production coverage replaces all source pathnames after launcher adoption and
proves retained identity, active multi-drive I/O, shared writable external
bytes, redaction, death-order cleanup, and immutable state/memory.
...
promotes four public native-v2 process/snapshot records, so the current
inventory is 233/165/3/17.
