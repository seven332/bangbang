...
| --- | --- | --- | --- | --- |
| Native-v2 state, File/COW memory, artifact transaction, public process lifecycle, and focused reconstruction | current 2.11 complete-serial multi-vCPU Full/File lifecycle with independently optional profile-3 storage, entropy, balloon, virtio-mem, and network/MMDS implemented and verified; exact 2.3–2.10 and frozen native-v1 remain readable | unit, fixed binary fixtures, hostile component/registry/device/FDT/network/MMDS mutations, artifact and override fault/authority checks, API/process routing, all-32-product restore-stage injection, signed HVF, signed direct MMIO/PCI executable, signed App Sandbox and production bundle, docs | #1490, #1525, #1526, #1528, #1529, #1566, #1567, #1568, #1569, #1575, #1576, #1577, #1578, #1583, #1584, #1585, #1586, #1587, #1588, #1589, #1616, #1617, #1634, #1651, #1652, #1665, #1666, #1680, #1681, #1697, #1698, #1715, #1716 | The current writer emits `2.11.0`; optional network/MMDS kind 12 joins unchanged kinds 7–11 over coherent MMIO or PCI. Kind 12 is capped at 512 KiB with an 83,552-byte 16-interface worst case and excludes host backend owners, handles, packets, connections, MMDS data, tokens, metrics, and clocks. Every network load requires an exact redacted clone-local override set and constructs fresh backend/network/MMDS owners. Signed direct and normal-production/App-Sandbox MMIO/PCI V1/V2 matrices prove explicit-Paused recapture and automatic clones, empty/reseeded MMDS, source TCP/token loss, fresh-session success, immutable inputs, fresh metrics, malformed state/memory and overrides, cancellation/death cleanup, retry, and containment without vmnet authority. Diff, native-v2 Uffd, vsock restore, Firecracker bytes, source owner/dirty identity, synchronous RSS, and broad portability remain explicit nonclaims. |
| Direct pmem mapping, root boot, and native-v2 restore | implemented and verified for startup MMIO/PCI, non-root runtime PCI, complete capture-ready live state, exact native-v2 2.6 through current 2.11 profile-3 serialization/restore | unit, process e2e, signed HVF capture equality, focused profile-3 fault/authority tests, signed executable storage matrix, signed normal-production bundle storage matrix, docs, pinned-source compare | #1439, #1444, #1448, #1471, #1634, #1651, #1652, #1665, #1666, #1680, #1681, #1697, #1698, #1715, #1716 | One reference-counted file/private-tail mapping is registered directly with HVF. Profile 3 binds exact file/mapped geometry and restores direct paths or exact `PmemBacking` grants with the complete block/pmem batch; current 2.11 composes that unchanged storage graph with required serial and optional entropy/balloon/virtio-mem/network state. Signed rooted pmem-only and rootless mixed MMIO/PCI cells prove shared writable prefix epochs, unchanged read-only peers, a zero DAX private tail on every fresh mapping, limiter/retry and interrupt continuation, recapture, immutable state/memory, pathname-replacement resistance, and cleanup. Pmem remains outside ordinary RAM dirty epochs, and both checked pmem composite records are terminal. |
...
| Capability inventory enforcement | structural inventory implemented; capability audit in progress | unit, workspace CI, docs, pinned-source compare | #1348, #1349, #1527, #1546, #1547, #1548, #1549, #1550, #1551, #1552, #1553, #1554, #1555, #1578, #1589, #1616, #1617, #1634, #1651, #1652, #1665, #1666, #1680, #1681, #1697, #1698, #1715, #1716 | The machine-owned v1.16.0 source manifest and human overlay keep every disposition mechanically checked. #1715 activates current 2.11 with optional network/MMDS kind 12 across all 32 products; #1716 promotes exactly `api-property:SnapshotLoadParams.network_overrides`, `corpus:snapshot-network-clones`, `corpus:mmds-user-guide`, and `semantic.mmds:tcp-token-session-and-isolation`. Counts are 246/152/3/17. Diff, vsock restore, tools, Firecracker interoperability, broad portability, external vmnet, and performance aggregates remain under audit or explicit nonclaims. |
...
| Product PCI and modern virtio-pci | all-virtio startup, aggregate runtime hotplug/live storage certification, and current native-v2 2.11 block/pmem/serial plus optional entropy, balloon, virtio-mem, and network/MMDS persistence; vsock remains capture-ready only | unit, process e2e, signed HVF capture/equality/reconstruction, signed executable and production bundle restore matrices, docs, pinned-source compare | #1416, #1417, #1418, #1419, #1420, #1421, #1422, #1423, #1444, #1448, #1471, #1475, #1516, #1583, #1584, #1585, #1586, #1587, #1588, #1589, #1616, #1617, #1634, #1651, #1652, #1665, #1666, #1680, #1681, #1697, #1698, #1715, #1716 | One immutable all-virtio transport is selected after target/GIC-MSI and exact endpoint/vector preflight. Exact 2.6–2.10 device components remain unchanged; current 2.11 may add network/MMDS in canonical PCI slot/route order. Kind 12 retains common virtio/BAR/MSI-X/interrupt/registry placement but reconstructs fresh backend, packet-I/O, callback, metric, scheduler, endpoint, route, and MMDS owners from an exact destination override set. Signed direct and contained matrices prove restored guest continuation, MMDS session loss/freshness, recapture, immutable clone isolation, failure cleanup, and no-vmnet containment. Automatic guest hotplug notification, vsock persistence, external vmnet certification, and KVM ITS identity remain deferred. |
...
| Snapshots and restore | current public native-v2 2.11 complete-serial Full/File multi-vCPU lifecycle with independently optional profile-3 storage, entropy, balloon, virtio-mem, and network/MMDS implemented and verified; exact 2.3–2.10 and frozen native-v1 File/Uffd readers retained | unit, API/process, fixed/hostile exact fixtures, signed HVF capture/reconstruction, all-32-product resource/failure injection, signed direct and normal-production MMIO/PCI matrices, signed App Sandbox restore, docs | #543, #1263, #1264, #1390, #1395, #1396, #1441, #1525, #1526, #1528, #1529, #1554, #1575, #1576, #1577, #1578, #1583, #1584, #1585, #1586, #1587, #1588, #1589, #1609, #1610, #1611, #1612, #1613, #1614, #1615, #1616, #1617, #1634, #1651, #1652, #1665, #1666, #1680, #1681, #1697, #1698, #1715, #1716 | Public create admits Paused Full sources with 1–32 vCPUs, required serial, optional matching-transport kinds 7 and 9–12, and no vsock/boot timer; it publishes current `2.11.0` memory first and state last. Network loads require one redacted clone-local override per saved interface. Fresh destination providers, packet-I/O, metrics, schedules, routes, endpoints, and MMDS stacks replace every excluded source owner/session. Signed direct and contained MMIO/PCI V1/V2 evidence proves explicit/automatic continuation, recapture, empty/reseeded MMDS, source TCP/token loss, fresh-session success, immutable clones, fresh metrics, malformed/override/cancellation/death cleanup, retry, and no-vmnet containment alongside prior device continuation. The format remains bangbang-native and unauthenticated. Diff, native-v2 Uffd, vsock restore, Firecracker artifacts, source owners/packets/connections, synchronous RSS, and broad portability remain unsupported or under audit. |
| Memory hotplug | live MMIO/PCI lifecycle plus exact native-v2 2.10 serialization retained unchanged by 2.11, fresh mixed-memory restore, and signed continuation implemented and verified | unit, fixed/hostile codec/bitmap/extent/materialization tests, API/process, all-product controller/owner rollback, signed HVF, signed executable, signed production bundle, docs | #544, #942, #952, #1022, #1026, #1028, #1030, #1032, #1034, #1040, #1042, #1044, #1046, #1050, #1333, #1334, #1419, #1462, #1474, #1538, #1697, #1698 | Strict configuration/status and live STATE/PLUG/UNPLUG/UNPLUG_ALL operate in configured blocks with failure-atomic guest/HVF/dirty/accounting mutation and Firecracker-shaped metrics. Exact 2.10 kind 11 persists bounded configuration, features, config space, queue, transport, and canonical plugged topology, exactly binds kind-1 memory extents, and restores private base RAM plus one fresh shared aperture per destination. Focused coverage includes hostile geometry/bitmap/extents, all sixteen pre-network products, block-granular materialization, same-process peers, controller commit/cancellation, owner rollback, and recapture. Signed direct and contained MMIO/PCI sources and explicit/automatic destinations verify nonzero restored bytes first, then partial shrink, Linux reprobe UNPLUG_ALL/replug, growth, final removal, exact success/failure metrics, immutable inputs, pathname replacement, malformed state/memory, all death orders, and cleanup. No DELETE route or synchronous RSS claim is exposed; Diff/Uffd/vsock restore and broad portability remain separate work. |
...
| Public native-v2 Full/File endpoint activation | implemented current 2.11 complete-serial subset with independently optional regular-file block/pmem profile-3 storage, entropy, balloon, virtio-mem, and network/MMDS, plus exact native-v2 2.3–2.10 and frozen native-v1 readers | runtime, API socket, process lifecycle, signed direct executable and normal-production/App-Sandbox matrices, docs | #543, #1276, #1396, #1575, #1576, #1577, #1578, #1589, #1616, #1617, #1634, #1651, #1652, #1665, #1666, #1680, #1681, #1697, #1698, #1715, #1716 | Public Full create emits exact native-v2 2.11 with required serial and all 32 optional-component products on one transport. Load classifies one opened state, selects frozen native-v1 or exact 2.3–2.11 File/COW, performs exact backing authority adoption, materializes memory, requires a complete redacted network override set when kind 12 is present, and constructs fresh optional-device owners before Paused publication. Signed direct and contained MMIO/PCI V1/V2 matrices prove grants, pathname replacement, recapture, explicit/automatic resume, restored device continuation, network session/token loss and freshness, metrics, immutable clones, malformed/override/cancellation/death containment, retry, and cleanup. |
...
after matching direct and contained signed certification. The current
inventory is 246/152/3/17.
