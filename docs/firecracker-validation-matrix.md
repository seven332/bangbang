...
| Capability inventory enforcement | structural inventory implemented; capability audit in progress (228 implemented, 169 audit, 4 feasible-missing, 17 proven impossible) | unit, workspace CI, docs, pinned-source compare | #1348, #1349, #1420, #1421, #1422, #1423, #1444, #1445, #1446, #1447, #1448, #1449, #1461, #1462, #1471, #1473, #1474, #1475, #1479, #1493, #1496, #1494, #1518, #1527, #1546, #1547, #1548, #1549, #1550, #1551, #1552, #1553, #1554 | The machine-owned v1.16.0 source manifest and human overlay keep every disposition mechanically checked. #1546 moves only `corpus:snapshot-page-faults` to #1527-owned feasible-but-undelivered status; #1547-#1553 deliver the protocol, coordinator, host/guest fault planes, contained grant, removal/failure behavior, and complete consumer gates. #1554 adds direct and contained native-v1 pager restore with state-bound sessions and transactional owner assembly, while deliberately leaving the aggregate disposition and 228/169/4/17 counts unchanged until #1555 final certification. The family ledgers retain only their named snapshot/restore, external vmnet, performance/observability, tool, and final-export owners. |
| UFFD-equivalent snapshot paging | narrow native-v1 direct/contained macOS restore implemented; aggregate remains feasible-but-undelivered pending final certification | checked upstream/platform/consumer ledger, pager unit/process/reference-peer tests, session/launcher tests, lazy-memory concurrency tests, host/guest fault unit and signed/App Sandbox tests, direct signed restore, production-bundle contained restore | #1527, #1546, #1547, #1548, #1549, #1550, #1551, #1552, #1553, #1554 | `bangbang-pager-v1` provides the bounded offset-only peer protocol, and `LazyGuestMemory` plus the task-local Mach and HVF stage-two bridges retain external demand ownership without exposing task ports or host addresses. Removal is revoke-hide-zero-acknowledge-commit, and peer failure releases pending work once. #1554 accepts `backend_type = "Uffd"` only on macOS Apple Silicon for the narrow fixed-memory native-v1 profile with dirty tracking disabled. Platform/profile/consumer/grant preflight precedes path, socket, artifact, and backend access. State-bound image ID/checksum/length derive the pager session; exact GPA topology, header-relative source offsets, limits, root, and peer negotiation validate before the rollback-owned memory/bridge/mapping/vCPU/device/runtime graph is published. Direct mode performs a bounded Unix connection. Contained mode one-time claims the launcher-connected stream and gives the worker no snapshot-memory file grant. Signed direct and production-bundle guests restore, resume, reach `SYSTEM_OFF`, and observe orderly pager shutdown. File/COW remains distinct, no lazy failure falls back eagerly, and the protocol is not Linux UFFD wire-compatible. The checked ledger stays nonterminal until #1555 completes the final stress, entitlement, and full-matrix gate. |
