...
| --- | --- | --- | --- | --- |
| Native-v2 state, File/COW memory, artifact transaction, public process lifecycle, and focused reconstruction | current 2.12 complete-serial multi-vCPU Full/File lifecycle with independently optional profile-3 storage, entropy, balloon, virtio-mem, network/MMDS, and vsock implemented and verified; exact 2.3–2.11 and frozen native-v1 remain readable | unit, fixed binary fixtures, hostile component/registry/device/FDT/network/MMDS/vsock mutations, artifact and override fault/authority checks, API/process routing, all-64-product restore-stage injection, signed HVF, signed direct MMIO/PCI executable, signed App Sandbox and production bundle, docs | #1490, #1525, #1526, #1528, #1529, #1566, #1567, #1568, #1569, #1575, #1576, #1577, #1578, #1583, #1584, #1585, #1586, #1587, #1588, #1589, #1616, #1617, #1634, #1651, #1652, #1665, #1666, #1680, #1681, #1697, #1698, #1715, #1716, #1735, #1736 | The current writer emits `2.12.0`; optional vsock kind 13 joins unchanged kinds 7–12 over coherent MMIO or PCI. Kind 13 has a 640-byte worst case under a defensive 64-KiB cap and excludes connections, accepts, packets, wakeups, deadlines, metrics, descriptors, grants, sessions, and handles. Load validates the captured or overridden selector before exact direct/contained authority access and creates fresh clone-local socket/device ownership with empty live work. Signed direct MMIO/PCI matrices prove old-stream reset, event acknowledgement before RX, live TX, preserved listeners, deterministic bidirectional multistream/half-close, Paused gating, cursor continuation, simultaneous immutable clones, recapture, and fresh metrics. Signed normal-production/App-Sandbox MMIO/PCI coverage adds exact grants, replacement safety, malformed state/memory, no-device/missing-authority failures, cancellation, independent death orders, retry, redaction, containment, and cleanup. Diff, native-v2 Uffd, Firecracker bytes, live-peer migration, source owner/dirty identity, synchronous RSS, and broad portability remain explicit nonclaims. |
| Direct pmem mapping, root boot, and native-v2 restore | implemented and verified for startup MMIO/PCI, non-root runtime PCI, complete capture-ready live state, exact native-v2 2.6 through current 2.12 profile-3 serialization/restore | unit, process e2e, signed HVF capture equality, focused profile-3 fault/authority tests, signed executable storage matrix, signed normal-production bundle storage matrix, docs, pinned-source compare | #1439, #1444, #1448, #1471, #1634, #1651, #1652, #1665, #1666, #1680, #1681, #1697, #1698, #1715, #1716, #1735, #1736 | One reference-counted file/private-tail mapping is registered directly with HVF. Profile 3 binds exact file/mapped geometry and restores direct paths or exact `PmemBacking` grants with the complete block/pmem batch; current 2.12 composes that unchanged storage graph with required serial and optional entropy/balloon/virtio-mem/network/vsock state. Signed rooted pmem-only and rootless mixed MMIO/PCI cells prove shared writable prefix epochs, unchanged read-only peers, a zero DAX private tail on every fresh mapping, limiter/retry and interrupt continuation, recapture, immutable state/memory, pathname-replacement resistance, and cleanup. Pmem remains outside ordinary RAM dirty epochs, and both checked pmem composite records are terminal. |
...
| Capability inventory enforcement | structural inventory implemented; capability audit in progress | unit, workspace CI, docs, pinned-source compare | #1348, #1349, #1527, #1546, #1547, #1548, #1549, #1550, #1551, #1552, #1553, #1554, #1555, #1578, #1589, #1616, #1617, #1634, #1651, #1652, #1665, #1666, #1680, #1681, #1697, #1698, #1715, #1716, #1735, #1736 | The machine-owned v1.16.0 source manifest and human overlay keep every disposition mechanically checked. #1735 activates current 2.12 with optional vsock kind 13 across all 64 products; #1736 promotes exactly the three `VsockOverride` API identities, `corpus:vsock`, the snapshot network/vsock clone aggregate, and the vsock reset/RX-gating aggregate. Counts are 252/146/3/17. Diff/Uffd, tools, Firecracker interoperability, live-peer migration, broad portability, external vmnet, and performance aggregates remain under audit or explicit nonclaims. |
...
| Product PCI and modern virtio-pci | all-virtio startup, aggregate runtime hotplug/live storage certification, and current native-v2 2.12 block/pmem/serial plus optional entropy, balloon, virtio-mem, network/MMDS, and vsock persistence | unit, process e2e, signed HVF capture/equality/reconstruction, signed executable and production bundle restore matrices, docs, pinned-source compare | #1416, #1417, #1418, #1419, #1420, #1421, #1422, #1423, #1444, #1448, #1471, #1475, #1516, #1583, #1584, #1585, #1586, #1587, #1588, #1589, #1616, #1617, #1634, #1651, #1652, #1665, #1666, #1680, #1681, #1697, #1698, #1715, #1716, #1735, #1736 | One immutable all-virtio transport is selected after target/GIC-MSI and exact endpoint/vector preflight. Exact 2.6–2.11 device components remain unchanged; current 2.12 may add vsock in canonical PCI slot/route order. Kind 13 retains common virtio/BAR/MSI-X/interrupt/registry placement plus CID, selector, reset, queues, and cursor, but reconstructs fresh listener/device/metric/dispatcher/connection/cleanup owners from captured or overridden authority. Signed direct and contained matrices prove restored guest reset/RX/TX semantics, listener/multistream/half-close continuation, Paused gating, cursor and clone isolation, recapture, failures, death cleanup, retry, and containment. Automatic guest hotplug notification, external vmnet certification, and KVM ITS identity remain deferred. |
...
| Network and MMDS | MMIO-default and all-PCI startup/runtime lifecycle, portable packet semantics, direct-vmnet batching, bounded MMDS TCP/token sessions, capture-ready state, and exact native-v2 2.11 restore implemented and verified | unit, API/process, fixed/hostile kind-12 and override fixtures, signed HVF, signed direct executable, signed normal-production/App Sandbox, docs | #540, #962, #982, #1066, #1090, #1146, #1148, #1150, #1154, #1306, #1307, #1308, #1309, #1310, #1311, #1312, #1313, #1377, #1418, #1419, #1422, #1495, #1497, #1498, #1499, #1502, #1503, #1496, #1715, #1716 | Live initial/runtime MMIO/PCI configuration, queue and limiter semantics, bounded packet processing, process-local MMDS V1/V2, instance-bound tokens, metrics, isolation, capture, and teardown are implemented and signed. Exact 2.11 kind 12 retains portable interface/MMDS configuration and transport state while excluding providers, packet-I/O owners, callbacks, packets, ARP/TCP sessions, data, tokens, metrics, and clocks. Every load requires an exact unique clone-local override set and builds fresh owners. Signed direct and contained MMIO/PCI V1/V2 guests prove explicit-Paused recapture and automatic destinations, empty/reseeded data, source TCP/token loss, fresh-session success, immutable artifacts, fresh metrics, malformed state/memory, missing/duplicate/unknown override redaction, cancellation and death cleanup, retry, and all-MMDS operation without vmnet authority. The exact 35-record ledger is now 33 terminal with only broad external-vmnet and performance rows open. Positive external vmnet connectivity and host firewall policy remain #1378; performance reconciliation remains #1491; no repository credential or positive external result is claimed. |
| Virtio-vsock | complete API/live MMIO-or-PCI plus exact native-v2 2.12 snapshot/override/clone contract implemented and verified; all 14 directly named inventory records terminal | unit, API socket, process e2e, fixed/hostile kind-13 and override fixtures, signed HVF, signed direct executable, signed normal-production/App Sandbox bundle, docs | #541, #984, #1322, #1323, #1324, #1365, #1419, #1513, #1514, #1515, #1516, #1517, #1518, #1735, #1736 | Live behavior retains strict preboot configuration, three 256-entry queues, one shared 1023 active budget, bounded incomplete requests and packets, round-robin host-local ports, wrapping credit, both initiation directions, shutdown/reset, `EVENT_IDX`, aggregate metrics, exact teardown, and the supported indirect-descriptor extension. Kind 13 captures CID, inert selector, cursor, features, queues, interrupts/reset, and coherent MMIO/PCI placement while excluding connections, accepts, packets, wakeups, deadlines, metrics, descriptors, grants, sessions, and handles. Capture closes source connections and queues `TRANSPORT_RESET`; restored work is empty, RX waits for event acknowledgement, TX stays live, and guest listeners persist. `vsock_override` replaces the sole captured selector and rejects without a device before authority access. Direct load owns one exact inode; contained load consumes one exact directory/listener/connector transaction without fallback, helper insertion, or new entitlement. Signed direct MMIO/PCI evidence proves simultaneous immutable original-selector/override clones, old-stream loss, Paused work gating, preserved listeners, 4 guest-to-host plus 16 host-to-guest deterministic 4-KiB streams, half-close/EOF, exact clone-local cursor continuation, recapture, fresh metrics, and cleanup. Signed production/App Sandbox MMIO/PCI evidence adds pathname replacement, malformed state/memory, no-device and missing-authority faults, cancellation, worker-first and launcher-first death, later retry, redaction, containment, and exact session/socket/helper cleanup. PATCH/DELETE/runtime hotplug, broader CID routing, live-peer migration, automatic socket/grant migration, Firecracker bytes, performance parity, vhost/KVM, Diff/Uffd, and unconstrained cross-host portability remain explicit limits. |
...
| Snapshots and restore | current public native-v2 2.12 complete-serial Full/File multi-vCPU lifecycle with independently optional profile-3 storage, entropy, balloon, virtio-mem, network/MMDS, and vsock implemented and verified; exact 2.3–2.11 and frozen native-v1 File/Uffd readers retained | unit, API/process, fixed/hostile exact fixtures, signed HVF capture/reconstruction, all-64-product resource/failure injection, signed direct and normal-production MMIO/PCI matrices, signed App Sandbox restore, docs | #543, #1263, #1264, #1390, #1395, #1396, #1441, #1525, #1526, #1528, #1529, #1554, #1575, #1576, #1577, #1578, #1583, #1584, #1585, #1586, #1587, #1588, #1589, #1609, #1610, #1611, #1612, #1613, #1614, #1615, #1616, #1617, #1634, #1651, #1652, #1665, #1666, #1680, #1681, #1697, #1698, #1715, #1716, #1735, #1736 | Public create admits Paused Full sources with 1–32 vCPUs, required serial, optional matching-transport kinds 7 and 9–13, and no boot timer/vhost-user; it publishes current `2.12.0` memory first and state last. Network loads require one redacted clone-local override per saved interface; vsock loads use the captured selector or one validated override. Fresh destination owners replace every excluded source network/session/socket owner. Signed direct and contained MMIO/PCI evidence proves prior device continuation plus vsock reset acknowledgement/RX gating/live TX, preserved listeners, fresh multistream/half-close traffic, Paused gating, cursor continuation, independent immutable clones, recapture, fresh metrics, malformed/no-device/authority/cancellation/death cleanup, retry, redaction, and containment. The format remains Bangbang-native and unauthenticated. Diff, native-v2 Uffd, Firecracker artifacts, live-peer migration, synchronous RSS, and broad portability remain unsupported or under audit. |
| Memory hotplug | live MMIO/PCI lifecycle plus exact native-v2 2.10 serialization retained unchanged through 2.12, fresh mixed-memory restore, and signed continuation implemented and verified | unit, fixed/hostile codec/bitmap/extent/materialization tests, API/process, all-product controller/owner rollback, signed HVF, signed executable, signed production bundle, docs | #544, #942, #952, #1022, #1026, #1028, #1030, #1032, #1034, #1040, #1042, #1044, #1046, #1050, #1333, #1334, #1419, #1462, #1474, #1538, #1697, #1698 | Strict configuration/status and live STATE/PLUG/UNPLUG/UNPLUG_ALL operate in configured blocks with failure-atomic guest/HVF/dirty/accounting mutation and Firecracker-shaped metrics. Exact 2.10 kind 11 persists bounded configuration, features, config space, queue, transport, and canonical plugged topology, exactly binds kind-1 memory extents, and restores private base RAM plus one fresh shared aperture per destination. Focused coverage includes hostile geometry/bitmap/extents, all sixteen pre-network products, block-granular materialization, same-process peers, controller commit/cancellation, owner rollback, and recapture. Signed direct and contained MMIO/PCI sources and explicit/automatic destinations verify nonzero restored bytes first, then partial shrink, Linux reprobe UNPLUG_ALL/replug, growth, final removal, exact success/failure metrics, immutable inputs, pathname replacement, malformed state/memory, all death orders, and cleanup. No DELETE route or synchronous RSS claim is exposed; Diff/Uffd and broad portability remain separate work. |
...
| Remaining Firecracker devices | implemented supported subsets; transport and profile limits explicit | unit, API/process, signed HVF, signed direct executable, signed production bundle, docs | #544, #797, #800, #802, #804, #806, #808, #810, #812, #814, #815, #818, #869, #873, #875, #877, #888, #890, #892, #894, #896, #898, #900, #902, #904, #905, #908, #910, #912, #914, #920, #922, #926, #928, #930, #932, #934, #936, #938, #940, #960, #962, #964, #968, #970, #972, #988, #990, #1000, #1002, #1016, #1018, #1024, #1329, #1328, #1330, #1331, #1335, #1336, #1337, #1338, #1362, #1418, #1419, #1420, #1421, #1422, #1444, #1473, #1474, #1475, #1477, #1478, #1479, #1480, #1529, #1634, #1651, #1652, #1665, #1666, #1680, #1681, #1697, #1698, #1715, #1716, #1735, #1736 | Serial implements exact 2.7 restore, profile-3 storage 2.6 onward, entropy 2.8, balloon 2.9, virtio-mem 2.10, network/MMDS 2.11, and vsock 2.12 over MMIO/PCI. Exact 2.12 vsock restoration retains CID/selector/cursor/queue/reset/placement state, reconstructs empty-work owners through captured or overridden exact authority, and has signed direct/contained reset, listener, multistream, half-close, cursor, clone, failure, redaction, and cleanup evidence. Automatic guest hotplug notification and externally certified vmnet connectivity remain explicit limits. |
...
| Public native-v2 Full/File endpoint activation | implemented current 2.12 complete-serial subset with independently optional regular-file block/pmem profile-3 storage, entropy, balloon, virtio-mem, network/MMDS, and vsock, plus exact native-v2 2.3–2.11 and frozen native-v1 readers | runtime, API socket, process lifecycle, signed direct executable and normal-production/App-Sandbox matrices, docs | #543, #1276, #1396, #1575, #1576, #1577, #1578, #1589, #1616, #1617, #1634, #1651, #1652, #1665, #1666, #1680, #1681, #1697, #1698, #1715, #1716, #1735, #1736 | Public Full create emits exact native-v2 2.12 with required serial and all 64 optional-component products on one transport. Load classifies one opened state, selects frozen native-v1 or exact 2.3–2.12 File/COW, performs exact backing authority adoption, materializes memory, requires complete redacted network overrides when kind 12 is present, accepts at most one validated `vsock_override` when kind 13 exists, and constructs fresh optional-device owners before Paused publication. Signed direct and contained MMIO/PCI matrices prove grants, replacement, recapture, explicit/automatic resume, restored device continuation, network session/token freshness, vsock reset/RX/TX/listener/multistream/half-close/cursor semantics, fresh metrics, immutable clones, malformed/override/authority/cancellation/death containment, retry, redaction, and cleanup. |
...
except where exact 2.7 serial, exact 2.8 entropy, exact 2.9 balloon, and exact
...
activates exact 2.10, and #1698 promotes only the memory-hotplug corpus and
virtio-mem lifecycle aggregate after matching signed certification. #1715
activates current exact 2.11, and #1716 promotes the network override property,
...
current exact 2.12, and #1736 promotes the three `VsockOverride` API identities,
vsock corpus, snapshot network/vsock clone semantic, and vsock reset/RX-gating
semantic after strict direct and contained signed certification. The current
inventory is 252/146/3/17.
