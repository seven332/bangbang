...
order and bytes, every getter failure and retry, bounded accessors, twenty-six-way
...
accessors, twenty-six-way admission, abandonment, channel, panic, and cleanup.
...
backend failure and retry, raw accessors, twenty-six-way admission,
...
backend failure and retry, fixed-size access, twenty-six-way admission,
abandonment, channel, panic, and cleanup. Signed HVF coverage accepts only
documented unavailability/inactivity or two complete idle-vCPU captures without
...
exact ordering, owner-thread dispatch, twenty-six-way conflicts,
...
twenty-six-way conflicts, abandonment, channels, queued destruction, unwind,
...
full retry, exact ordering, owner-thread dispatch, twenty-six-way conflicts,
abandonment, channels, queued destruction, unwind, panic, shutdown, and both
