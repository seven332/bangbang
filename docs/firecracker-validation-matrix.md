...
| --- | --- | --- | --- | --- |
| Native-v2 state, File/COW memory, artifact transaction, public process lifecycle, and focused reconstruction | current 2.6 regular-file block-and-pmem multi-vCPU Full/File lifecycle implemented and verified; exact block-only 2.5, single-root 2.4, device-free 2.3, and frozen native-v1 remain readable | unit, fixed binary fixtures, hostile component/registry/device/FDT mutations, artifact fault/authority checks, API/process family routing, typed complete-set storage authority and restore-stage fault injection, signed three-vCPU HVF, signed public rooted/rootless MMIO/PCI executable, signed App Sandbox and production bundle, docs | #1490, #1525, #1526, #1528, #1529, #1566, #1567, #1568, #1569, #1575, #1576, #1577, #1578, #1583, #1584, #1585, #1586, #1587, #1588, #1589, #1616, #1617, #1634 | The current writer emits `2.6.0` with device-graph kind 7 profile 3 after the memory/machine/global/topology/vCPU/time graph. It admits Paused Full sources with 1–32 vCPUs and 1–64 ordered regular-file block/pmem records over matching MMIO or the product PCI budget, with no root or one first cross-storage root. Profile 3 persists exact block and pmem configuration/runtime/limiter/queue/interrupt/mapping/transport state and loads through one direct or contained typed complete-set authority transaction without fallback. Exact 2.5 retains its profile-2 block-only contract. Signed direct and normal-production evidence proves rooted pmem-only/rootless mixed MMIO/PCI reconstruction, active persistence, limiter and interrupt progress, recapture, immutable state/memory reuse, deliberate shared writable external prefixes, zero fresh pmem private tails, retained descriptor identity, worker/launcher cleanup, and explicit/automatic resume. CRCs cover state/metadata only; external backing authentication/encryption and operator serialization are required. Other optional devices/general serial state, native-v2 Uffd, Diff/merge, overrides/editing, Firecracker bytes, and broad portability remain Wave 6 work. |
| Direct pmem mapping, root boot, and native-v2 restore | implemented and verified for startup MMIO/PCI, non-root runtime PCI, complete capture-ready live state, and native-v2 2.6 profile-3 serialization/restore | unit, process e2e, signed HVF capture equality, focused profile-3 fault/authority tests, signed executable storage matrix, signed normal-production bundle storage matrix, docs, pinned-source compare | #1439, #1444, #1448, #1471, #1634 | One reference-counted file/private-tail mapping is registered directly with HVF. Writable file prefixes use a shared host mapping; read-only guest mappings use a private write-capable host view required by HVF while guest permissions stay read-only. Flush synchronizes exactly the nonzero file prefix with `MS_SYNC`; the aligned tail is volatile. Profile 3 binds exact file/mapped geometry and restores direct paths or exact `PmemBacking` grants with the complete block/pmem batch. Signed rooted pmem-only and rootless mixed MMIO/PCI cells prove shared writable prefix epochs, unchanged read-only peers, a zero DAX private tail on every fresh mapping, limiter/retry and interrupt continuation, recapture, immutable state/memory, pathname-replacement resistance, and cleanup. Pmem remains outside ordinary RAM dirty epochs, and both checked pmem composite records are terminal. |
...
| Capability inventory enforcement | structural inventory implemented; capability audit in progress | unit, workspace CI, docs, pinned-source compare | #1348, #1349, #1527, #1546, #1547, #1548, #1549, #1550, #1551, #1552, #1553, #1554, #1555, #1578, #1589, #1616, #1617, #1634 | The machine-owned v1.16.0 source manifest and human overlay keep every disposition mechanically checked. #1578 promoted the snapshot-version argument, complete instance/version-output semantic, aggregate run operation, and minimal Full create/load public-lifecycle semantic. #1589 advanced that lifecycle to exact 2.4 singleton-root artifacts; #1616/#1617 added exact 2.5 profile-2 block artifacts; #1634 advances the current writer to 2.6 profile 3 and promotes exactly the final two pmem composites after signed direct/contained certification. Other snapshot corpora and API/schema aggregates remain under audit for Diff, optional devices other than pmem/MMDS, tools, Firecracker interoperability, and portability. |
...
| Process CLI and API socket | 25 of 29 inventory records implemented and verified; two proven platform impossible; only two broad source corpora remain under audit | unit, API socket, process e2e, signed process, signed App Sandbox process, signed production bundle, pinned-source compare | #536, #545, #1008, #1010, #1048, #1058, #1060, #1070, #1092, #1260, #1302, #1352, #1365, #1368, #1384, #1419, #1578, #1589, #1616, #1617, #1634 | The checked 23-argument contract has 21 implemented leaves and two terminal seccomp platform exclusions. It covers argument precedence, Unicode identity, limits, readiness, fd-table behavior, signals including nonfatal SIGPIPE, socket ownership/cleanup, configuration startup, PCI, and current native snapshot output. `--snapshot-version` prints `v2.6.0`; bounded direct or exact-granted description reports the actual validated native-v1 or native-v2 version and explicitly rejects Firecracker bytes. The complete instance/version-output semantic and aggregate run operation are terminal. Only broad `corpus:design` and `corpus:getting-started` remain under audit for unrelated repository-wide claims. |
...
| Product PCI and modern virtio-pci | all-virtio startup, aggregate runtime hotplug/live storage certification, exact native-v2 2.6 block-and-pmem persistence, and entropy/vsock capture-ready ownership implemented; other optional-device persistence/restore deferred | unit, process e2e, signed HVF capture/equality/reconstruction, signed executable aggregate and rooted/rootless storage restore, signed production bundle aggregate and rooted/rootless storage restore, docs, pinned-source compare | #1416, #1417, #1418, #1419, #1420, #1421, #1422, #1423, #1444, #1448, #1471, #1475, #1516, #1583, #1584, #1585, #1586, #1587, #1588, #1589, #1616, #1617, #1634 | The supported macOS arm64/HVF product path selects one immutable all-virtio transport after target/GIC-MSI and exact 31-endpoint capacity preflight. The retained manager supports failure-atomic Running/Paused non-root block, pmem, and network transactions with exact teardown/reuse. Current native-v2 2.6 profile 3 persists and reconstructs every admitted block and pmem PCI endpoint, including configuration, queue, limiter/retry, mapping, common virtio, BAR/capability/MSI-X state, and registry placement under the same budget. Signed direct and normal-production rooted pmem-only/rootless mixed matrices prove active I/O, external prefix epochs, fresh private tails, recapture, immutable-pair reuse, and cleanup. Automatic guest notification beyond restored queue/interrupt continuation, persistence for other optional devices, external vmnet certification, and KVM ITS identity remain deferred. |
...
| Snapshots and restore | current public native-v2 2.6 regular-file block-and-pmem Full/File multi-vCPU lifecycle implemented and verified; exact block-only 2.5, singleton-root 2.4, device-free 2.3, and frozen native-v1 File/Uffd readers retained | unit, API socket, process e2e, signed HVF capture/reconstruction, typed complete-set resource/failure injection, signed direct rooted/rootless MMIO/PCI executable, signed App Sandbox and normal production-bundle restore, docs | #543, #1263, #1264, #1390, #1395, #1396, #1441, #1525, #1526, #1528, #1529, #1554, #1575, #1576, #1577, #1578, #1583, #1584, #1585, #1586, #1587, #1588, #1589, #1609, #1610, #1611, #1612, #1613, #1614, #1615, #1616, #1617, #1634 | Public create admits Paused Full sources with 1–32 vCPUs and 1–64 ordered regular-file block/pmem records over matching MMIO or the product PCI budget, no root or one first cross-storage root, no other optional devices/MMDS/boot timer, and canonical default UART state; it publishes current `2.6.0` memory first and profile-3 state last. Public load derives and atomically authorizes the exact typed block/pmem vector without fallback/override and commits it with the Paused owner. Signed direct and normal-production evidence proves rooted pmem-only/rootless mixed MMIO/PCI persistence, read-only protection, limiter/interrupt progress, recapture, exact grants, immutable state/memory, deliberate shared writable prefixes, zero fresh private tails, explicit/automatic resume, and worker/launcher cleanup. The format remains bangbang-native and unauthenticated. Diff, native-v2 Uffd, other optional devices/general serial, Firecracker artifacts, and broad portability remain unsupported or under audit. |
...
| Public native-v2 Full/File endpoint activation | implemented current 2.6 regular-file block-and-pmem profile-3 subset with exact native-v2 2.5/2.4/2.3 and frozen native-v1 readers | runtime, API socket, process lifecycle, signed direct executable, signed App Sandbox, signed production bundle, docs | #543, #1276, #1396, #1575, #1576, #1577, #1578, #1589, #1616, #1617, #1634 | Public Full create emits graph-required native-v2 2.6 for a rooted or rootless ordered vector of 1–64 regular-file block and pmem devices over MMIO or the product PCI budget. Public load classifies one opened state and selects frozen native-v1 File/Uffd, legacy device-free 2.3, singleton-root 2.4, block-only profile-2 2.5, or current profile-3 2.6 File/COW plus one exact typed keyed complete-set backing transaction. There is no ambient fallback or load-time storage override. Repeated destinations share externally managed writable block and pmem prefixes and require operator serialization; state/memory and File/COW RAM remain immutable/private, and each fresh pmem private tail starts zero. Signed direct and normal-production matrices cover rooted pmem-only/rootless mixed MMIO/PCI continuation, exact grants, recapture, explicit/automatic resume, finite retryable/terminal failures, and death cleanup. |
...
current native-v2 2.6 atomically adopts state/memory and resolves every inert
...
final two pmem storage composites, so the current inventory is 235/163/3/17.
