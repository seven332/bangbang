...
| Remaining Firecracker devices | implemented supported subsets; transport and profile limits explicit | unit, api socket, process e2e, signed HVF, signed executable, signed production bundle, docs | #544, #797, #800, #802, #804, #806, #808, #810, #812, #814, #815, #818, #869, #873, #875, #877, #888, #890, #892, #894, #896, #898, #900, #902, #904, #905, #908, #910, #912, #914, #920, #922, #926, #928, #930, #932, #934, #936, #938, #940, #960, #962, #964, #968, #970, #972, #988, #990, #1000, #1002, #1016, #1018, #1024, #1329, #1328, #1330, #1331, #1335, #1336, #1337, #1338, #1362, #1418, #1419, #1420, #1421 | Balloon implements validated inflate, hinting, statistics, and free-page reporting queues; accepted ranges are wholly mapped, split by owner, aligned inward, zeroed then freed on Darwin, and processed best effort before acknowledgement with requested/advised/skipped/failure metrics. Signed coverage proves driver binding, reporting bit 5, nonzero actual pages, hinting control, and nonzero reporting activity without a synchronous footprint claim. Pmem implements pre-boot backing validation/mapping, exact read-only/read-write contained-grant adoption, move-only startup ownership, public selected-transport MMIO/FDT or modern PCI attachment, targeted lazy flush of only the notified device, no flush for empty or malformed-only events, one-op plus exact-backing-length rate limiting, pending session-owned retry, atomic limiter-only live PATCH that retains backing authority, peer isolation, metrics, and signed initial-limiter/PATCH/read/flush proof. Public PCI now also supports transactional non-root Running/Paused PUT/DELETE with aligned first-fit guest ranges, exact dynamic HVF shadows, targeted flush before removal, failure rollback, generation-safe metrics, and direct or unused contained-grant authority. Signed direct and production-bundle tests prove two insert/flush/remove rounds and exact same-ID/PCI-slot/guest-range reuse without pathname reopening. Hidden and signed product modern virtio-pci gates reuse the canonical pmem device and host-range flush adapter, prove stable identity plus guest read/write/flush persistence, and require no simultaneous pmem MMIO node. The all-PCI product gate additionally proves balloon, pmem, and entropy positive MSI-X operation together. Entropy implements the 64-KiB request cap, 64-byte aarch64 seed, optional limiter/retry, metrics, and signed `/dev/hwrng` proof. Paired reusable-page accounting, optional-device snapshots, pmem root/direct mapping/dirty tracking, ARM PVTime, mutable VMClock restore, and developer-preview PCI runtime network attach/delete remain explicit limits. |
