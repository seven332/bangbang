...
| Observability: logger, metrics, serial | partial | unit, api socket, process e2e, signed process, signed HVF | #542 | Minimal logger, metrics, startup timing, flush metrics, selected GET, PUT, PATCH, and `/actions` API request counters, and serial output paths are covered. Full Firecracker counters, periodic flush, and full log routing remain deferred. |
