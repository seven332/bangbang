...
order and bytes, every getter failure and retry, bounded accessors, thirty-two-way
...
accessors, thirty-two-way admission, abandonment, channel, panic, and cleanup.
...
backend failure and retry, raw accessors, thirty-two-way admission,
...
backend failure and retry, fixed-size access, thirty-two-way admission,
abandonment, channel, panic, and cleanup. Signed HVF coverage accepts only
documented unavailability/inactivity or two complete idle-vCPU captures without
...
exact ordering, owner-thread dispatch, thirty-two-way conflicts,
...
thirty-two-way conflicts, abandonment, channels, queued destruction, unwind,
...
full retry, exact ordering, owner-thread dispatch, thirty-two-way conflicts,
abandonment, channels, queued destruction, unwind, panic, shutdown, and both
...
owner-thread dispatch, thirty-two-way conflicts, abandonment, channels,
...
and full retry, exact ordering, owner-thread dispatch, thirty-two-way
