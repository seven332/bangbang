...
The supported Full/Diff and memory-rebase baseline is complete. Broader
...
- snapshot inspection, VM-state/register editing, and architecture-specific
  editor policy; and
...
certification are active. Snapshot inspection/register editing and broader
cross-profile certification remain separate issue-sized areas.
