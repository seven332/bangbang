...
- HVF vCPU state capture: X0-X30, PC, and CPSR; raw SP_EL0, SP_EL1, ELR_EL1,
  ...
  keys; raw physical timer CNTKCTL, control, and CVAL values; raw virtual timer
  mask, offset, control, and CVAL values; and CPU-level IRQ/FIQ pending values
  have owner-thread capture subsets.
  ...
  timer offset and absolute physical-timer comparator need explicit restore-time
  adjustment policies;
