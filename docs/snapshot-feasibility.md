...
- HVF vCPU state capture: X0-X30, PC, and CPSR; raw SP_EL0, SP_EL1, ELR_EL1,
  ...
  translation, baseline SIMD/FP, and pointer-authentication key values also
  have isolated low-level owner-thread restore operations, without snapshot
