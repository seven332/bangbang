...
context and SME system-register captures.
...
and SIMD/FP captures
and is
exposed through both boot-session forms. `TPIDR2_EL0` is captured separately
with SME system registers; wider system state, validation, persistence, and
restore remain outside this value. The supervisor lease and public snapshot
