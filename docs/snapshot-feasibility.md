...
identification, translation, pointer-authentication, and thread-context captures.
...
SVE/SME identification, pointer-authentication, and SIMD/FP captures and is
...
- HVF vCPU state capture: X0-X30, PC, and CPSR; raw SP_EL0, SP_EL1, ELR_EL1,
  ...
  compatibility metadata; raw MDCCINT_EL1 and MDSCR_EL1 debug controls; raw
  ...
  Remaining system registers, streaming SVE/SME execution state, and other
