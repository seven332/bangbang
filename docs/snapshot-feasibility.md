...
`SMCR_EL1.LEN`; P/ZA/ZT0, setters and transitions, layout interpretation,
...
identification, SME PSTATE, SME Z-register, translation, pointer-authentication,
...
still omits P/ZA/ZT0 data. Neither value defines a restore or snapshot-schema
contract.
...
SME Z-register, system-context, and SIMD/FP captures and is exposed through both boot-session
...
- HVF vCPU state capture: X0-X30, PC, and CPSR; raw SP_EL0, SP_EL1, ELR_EL1,
  ...
  Remaining system registers, streaming SVE/SME P/ZA/ZT0 data, and other
