...
and a future ZA buffer-sizing prerequisite, not
...
`SMCR_EL1.LEN`; P predicates are captured separately. ZA/ZT0, setters and
...
`SMCR_EL1.LEN`; Z registers are captured separately. ZA/ZT0, setters and
...
identification, SME PSTATE, SME Z-register, SME P-register, translation, pointer-authentication,
...
ZA/ZT0 data remain omitted. None of these values defines a restore or snapshot-schema
contract.
...
SME Z-register, SME P-register, system-context, and SIMD/FP captures and is exposed through both boot-session
...
- HVF vCPU state capture: X0-X30, PC, and CPSR; raw SP_EL0, SP_EL1, ELR_EL1,
  ...
  Remaining system registers, streaming SVE/SME ZA/ZT0 data, and other
