...
- HVF vCPU state capture: X0-X30, PC, and CPSR; raw SP_EL0, SP_EL1, ELR_EL1,
  ...
  thread-context, translation, system-context, baseline SIMD/FP, and pointer-
  authentication key values also have isolated low-level owner-thread restore
  operations. CPU-level IRQ/FIQ pending values have a separate paired restore
