...
only their target. Exposed retry timing, HVF retry wakeups, limiter-specific
metrics, snapshot state, and direct vmnet rate-limit evidence remain deferred. bangbang currently limits
...
schedule limiter retries, prove host connectivity, or provide public runtime
packet movement.
