...
The 29 promotions move the current global counts to 220/178/3/17.
...
cleanup through a single-use runtime adoption. Public native-v1 records still
omit vsock encoding/placement and load rejects overrides; record certification
and restored-guest proof remain #1518/#1490 work, so this classification does
not imply public snapshot compatibility.
...
transfers cleanup through single-use runtime adoption. Durable artifact
encoding, public placement, record certification, and restored-guest proof
remain #1518/#1490 work. The quiesced #1516 producer validates and normalizes
...
- virtio-vsock behavior beyond the **implemented supported live
  ...
  fallback, and single-use runtime adoption. Public native-v1 encoding,
  placement, record certification, and restored-guest proof remain #1518/#1490
  work rather than live snapshot-compatibility claims
