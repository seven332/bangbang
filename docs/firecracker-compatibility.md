...
throughput-oriented streaming, graceful half-close behavior, full credit
accounting, or broader socket lifecycle parity.
...
- virtio-vsock socket lifecycle beyond connection setup, forceful guest
  ...
  multi-stream exchanges; full graceful half-close state tracking, full
  virtio-vsock credit accounting, CID routing beyond current host/guest checks,
  broader socket lifecycle parity, and full event payload dispatch.
