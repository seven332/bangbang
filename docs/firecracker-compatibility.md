...
and broader event types remain outside the live subset. Public native-v1
invocation, durable vsock capture, snapshot UDS override, restored resource
reconstruction, and restored-guest proof remain #1515-#1518/#1490 work, so this
classification does not imply snapshot compatibility.
...
gating primitives, and startup FDT attachment. It uses the
...
vsock capture, snapshot UDS override, restored resource reconstruction, and
restored-guest proof remain #1515-#1518/#1490 work.
...
- virtio-vsock behavior beyond the **implemented supported live
  ...
  vhost/KVM transports. Public native-v1 invocation, durable vsock capture,
  snapshot UDS override, restored resource reconstruction, and restored-guest
  proof remain #1515-#1518/#1490 work rather than live snapshot-compatibility
  claims
