...
balloon API request metric fields. bangbang emits a minimal top-level
`balloon` device metrics object for implemented virtio-balloon queue activity
and failures. The startup timing fields from Firecracker's
