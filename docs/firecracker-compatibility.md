...
descriptor processing, memory accounting, statistics, hinting, reporting, and
...
update only the local device register state, and queue notifications are not
dispatched into descriptor processing yet. Memory accounting, statistics,
