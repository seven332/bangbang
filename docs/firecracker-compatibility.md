...
launcher facet with no guest bytes or outgoing-network entitlement. Snapshots,
general dynamic post-Ready delivery, hard revocation, cross-filesystem socket
