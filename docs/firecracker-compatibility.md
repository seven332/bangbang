...
accepted TTL header. MMDS v2 GET token enforcement remains deferred.
...
- snapshots
- MMDS guest packet access, MMDS v2 GET token enforcement, TCP routing, and
  response delivery
