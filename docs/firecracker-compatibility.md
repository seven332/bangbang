...
payloads only on configured MMDS interfaces, keeps
...
SYN-ACK acknowledgement path, full TCP stream tracking, out-of-order reassembly,
retransmission policy, stateful RST policy, session timeout policy, and stricter
