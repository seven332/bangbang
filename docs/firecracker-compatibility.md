...
creates no artifact. Destination authority and UDS override, record
certification, native-v1 encoding/placement, and restored-guest proof remain
#1517-#1518/#1490 work, so this classification does not imply public snapshot
compatibility.
...
event types remain excluded. Durable artifact encoding, snapshot UDS
authority/override, record certification, placement, and restored-guest proof
remain #1517-#1518/#1490 work. The quiesced #1516 producer validates and
normalizes source ownership before the unchanged public optional-device
rejection; it does not by itself make the live subset publicly
snapshot-compatible.
...
- virtio-vsock behavior beyond the **implemented supported live
  ...
  unchanged optional-device rejection. Destination UDS authority/override,
  record certification, native-v1 encoding/placement, and restored-guest proof
  remain #1517-#1518/#1490 work rather than live snapshot-compatibility claims
