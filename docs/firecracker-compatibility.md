...
public run-loop control, power on secondary vCPUs, implement reboot-in-place
after `SYSTEM_RESET`, or implement full PSCI CPU control and process exit-code
parity for error power actions. Public
