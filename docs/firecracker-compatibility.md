...
uses an externally supplied listener, creates empty connection work, and rearms
the snapshot-origin RX gate. Quiesced owner traversal, destination authority and
UDS override, record certification, native-v1 encoding/placement, public
invocation, and restored-guest proof remain #1516-#1518/#1490 work, so this
classification does not imply public snapshot compatibility.
...
event types remain excluded. Public native-v1 invocation, durable
artifact encoding, quiesced owner capture, snapshot UDS authority/override,
record certification, placement, and restored-guest proof remain
#1516-#1518/#1490 work. The internal #1515 capture values and reconstruction
components do not by themselves make the live subset publicly snapshot-compatible.
...
- virtio-vsock behavior beyond the **implemented supported live
  ...
  vhost/KVM transports. Internal redacted MMIO/PCI capture and supplied-listener
  reconstruction are implemented, but quiesced owner traversal, destination UDS
  authority/override, record certification, native-v1 encoding/placement,
  public invocation, and restored-guest proof remain #1516-#1518/#1490 work
  rather than live snapshot-compatibility claims
