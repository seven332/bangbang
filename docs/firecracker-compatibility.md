...
requests and allocates Firecracker-shaped host local ports for future
host-initiated connections. Host socket accept, connection lifecycle, guest-initiated
...
requests into a guest port and allocate Firecracker-shaped host local ports for
future host-initiated connections. Host socket accept, connection lifecycle,
...
- virtio-vsock host socket accept and connection lifecycle, guest-initiated
  ...
  local port allocation, and the internal prepared resource/MMIO
