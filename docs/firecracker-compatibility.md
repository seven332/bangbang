...
beyond current host/guest checks, and event queue dispatch remain deferred.
...
- virtio-vsock socket lifecycle beyond connection setup, host-to-guest data
  ...
  checks, and event queue dispatch
