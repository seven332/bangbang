...
deterministic SYN-ACK, pure empty-payload MMDS FIN close packets, guest packets
carrying RST, unsupported empty control packets, and non-empty MMDS candidate TX
