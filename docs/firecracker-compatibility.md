...
counters, and observable request/event failures; `balloon` reports implemented
virtio-balloon queue activity and failures. Block rate-limiter metrics, latency
aggregates, hotplug/removal counters, and vhost-user-block metrics remain
