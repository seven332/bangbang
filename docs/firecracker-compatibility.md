...
remain pre-resource rejections, the protocol is not Linux UFFD wire-compatible,
and final certification remains open. The aggregate disposition and current
global counts remain 228/169/4/17.
