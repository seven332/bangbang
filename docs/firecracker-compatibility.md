...
| `GET`, `PUT`, `PATCH` | `/balloon` | recognized; rejected | Returns a balloon-specific unsupported fault. Real virtio-balloon device support, memory accounting, and runtime update behavior need a dedicated design. |
