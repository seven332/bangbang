...
The exact native-v2 2.6 through current 2.12 profile-3 matrices additionally run
...
virtio-mem, exact 2.11 may add network/MMDS, and current 2.12 may add vsock on
...
| `corpus:pmem` | implemented and verified | Complete applicable live API, mapping, root, protection, flush, limiter, capture-ready state, hotplug/reuse, containment, and exact native-v2 2.6 through current 2.12 profile-3 serialization/restore. | Focused mapping/authority/fault tests; Direct and Contained aggregates; Direct and Contained snapshot aggregates. |
