...
The exact native-v2 2.6 through Full 2.12 profile-3 matrices additionally run
...
exact 2.8 may add entropy, exact 2.9 may add balloon, exact 2.10 may add
virtio-mem, exact 2.11 may add network/MMDS, and Full 2.12 may add vsock on the
matching transport. Diff 2.13 retains the complete product unchanged beside
mandatory Diff state.
...
| `corpus:pmem` | implemented and verified | Complete applicable live API, mapping, root, protection, flush, limiter, capture-ready state, hotplug/reuse, containment, and exact native-v2 2.6 through Full 2.12 profile-3 serialization/restore, retained unchanged in Diff 2.13. | Focused mapping/authority/fault tests; Direct and Contained aggregates; Direct and Contained snapshot aggregates. |
