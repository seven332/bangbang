...
The exact native-v2 2.6 through current 2.11 profile-3 matrices additionally run
...
virtio-mem, and current 2.11 may add network/MMDS on the matching transport.
...
| `corpus:pmem` | implemented and verified | Complete applicable live API, mapping, root, protection, flush, limiter, capture-ready state, hotplug/reuse, containment, and exact native-v2 2.6 through current 2.11 profile-3 serialization/restore. | Focused mapping/authority/fault tests; Direct and Contained aggregates; Direct and Contained snapshot aggregates. |
