...
The exact native-v2 2.6 through current 2.10 profile-3 matrices additionally run
...
exact 2.8 may add entropy, exact 2.9 may add balloon, and current 2.10 may add
virtio-mem on the matching transport.
...
| `corpus:pmem` | implemented and verified | Complete applicable live API, mapping, root, protection, flush, limiter, capture-ready state, hotplug/reuse, containment, and exact native-v2 2.6 through current 2.10 profile-3 serialization/restore. | Focused mapping/authority/fault tests; Direct and Contained aggregates; Direct and Contained snapshot aggregates. |
