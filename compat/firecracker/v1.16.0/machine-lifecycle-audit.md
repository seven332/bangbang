...
- Wave 6 has terminal current native-v2 2.8 Full/File create/load for complete
  serial state plus optional entropy and optional rooted/rootless regular-file
  block/pmem profile-3 vectors over MMIO/PCI, and retains exact
  2.7/2.6/2.5/2.4/2.3 plus frozen native-v1 readers. It still owns Diff
  artifacts, optional-device state other than serial, pmem, and entropy,
