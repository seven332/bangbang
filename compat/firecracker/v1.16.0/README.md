...
- [`metrics-device-producer-audit.json`](metrics-device-producer-audit.json) is
  ...
  #1789 delivery children per field. After #1845 it contains 212 implemented,
  two source-neutral, two terminal platform-zero, no planned, and 15
  provisional platform-zero records; only the final group is nonterminal and
  carries no evidence.
