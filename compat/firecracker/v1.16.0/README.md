...
- [`metrics-device-producer-audit.json`](metrics-device-producer-audit.json) is
  ...
  #1789 delivery children per field. After #1840 it contains 80 implemented,
  one source-neutral, 135 planned, and 15 provisional platform-zero records;
