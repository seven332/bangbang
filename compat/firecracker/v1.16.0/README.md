...
- [`metrics-device-producer-audit.json`](metrics-device-producer-audit.json) is
  ...
  #1789 delivery children per field. After #1842 it contains 133 implemented,
  one source-neutral, 82 planned, and 15 provisional platform-zero records;
