...
to reach the historical 383/0/2/33 endpoint. #1948 then promotes only those
two rows to reach the terminal 385/0/0/33 endpoint. The scoped gate accepts
only those exact phases and
