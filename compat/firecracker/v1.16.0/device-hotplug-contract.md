...
2.6 through current 2.12 profile 3 persist startup- or runtime-origin
...
network/MMDS state, and current 2.12 may add portable vsock state on the
selected MMIO or PCI transport. Boot-timer and vhost-user snapshot profiles
