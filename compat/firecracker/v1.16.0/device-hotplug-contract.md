...
2.6 through Full 2.12 profile 3 persist startup- or runtime-origin
...
balloon, exact 2.10 may add virtio-mem, exact 2.11 may add portable
network/MMDS state, and Full 2.12 may add portable vsock state on the selected
MMIO or PCI transport. Diff 2.13 retains the complete product unchanged beside
mandatory Diff state. Boot-timer and vhost-user snapshot profiles still reject
