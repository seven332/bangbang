...
pub use grant::{
    ...
    MAX_GRANT_RECORDS, MAX_GRANTS, MAX_SOCKET_CHILD_BYTES, ObjectIdentity, ResourceRole,
    SocketChild, decode_grant_frame, encode_grant_frame,
};
...
pub const SESSION_ENV_KEY: &str = "BANGBANG_INTERNAL_SESSION_V2";

/// Exact value required for [`SESSION_ENV_KEY`].
pub const SESSION_ENV_VALUE: &str = "2";
