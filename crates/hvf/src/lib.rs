...
pub use snapshot_v2::{
    ...
    HvfSnapshotV2GlobalState, HvfSnapshotV2MachineState, HvfSnapshotV2MultiBlockState,
    HvfSnapshotV2NativePath, HvfSnapshotV2PlatformState, HvfSnapshotV2SerialState,
...
pub use startup::{
    ...
    HvfSnapshotV2BalloonMmioRestoreStage, HvfSnapshotV2EntropyMmioRestoreError,
    ...
    RestoredHvfSnapshotV2BalloonMmioOwners, RestoredHvfSnapshotV2EntropyMmioOwners,
    RestoredHvfSnapshotV2EntropyPciOwners, RestoredHvfSnapshotV2MultiBlockMmioOwners,
