...
use crate::vcpu::{
    ...
    HvfArm64VcpuSmeZRegisterState, HvfArm64VcpuSveSmeIdentificationRegisterState,
    ...
    capture_arm64_vcpu_sme_system_register_state_with, capture_arm64_vcpu_sme_z_register_state,
