...
pub const NATIVE_V2_SNAPSHOT_VERSION: SnapshotFormatVersion = SnapshotFormatVersion::new(2, 8, 0);
...
const _: () = assert!(
    NATIVE_V2_STORAGE_DEVICE_GRAPH_COMPATIBILITY_VERSION.major()
        ...
        && NATIVE_V2_STORAGE_DEVICE_GRAPH_COMPATIBILITY_VERSION.minor() + 2
...
const _: () = assert!(
    NATIVE_V2_SERIAL_STATE_COMPATIBILITY_VERSION.major() == NATIVE_V2_SNAPSHOT_VERSION.major()
        && NATIVE_V2_SERIAL_STATE_COMPATIBILITY_VERSION.minor() + 1
            == NATIVE_V2_SNAPSHOT_VERSION.minor()
...
///
/// This semantic component was introduced by exact 2.4 and is required by
...
/// Canonical identity of the optional singleton native-v2 balloon state.
///
/// This semantic component is introduced by exact 2.9. Product-profile code
/// permits at most one semantic instance-zero component.
