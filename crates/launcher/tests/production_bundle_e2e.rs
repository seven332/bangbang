...
const SNAPSHOT_NETWORK_MMDS_SECTORS: u64 = 6;
const SNAPSHOT_NETWORK_MMDS_CONTINUE_OFFSET: u64 = VIRTIO_BLOCK_SECTOR_BYTES;
const SNAPSHOT_NETWORK_MMDS_CONNECTION_OFFSET: u64 = 3 * VIRTIO_BLOCK_SECTOR_BYTES;
const SNAPSHOT_NETWORK_MMDS_TOKEN_RESULT_OFFSET: u64 = 4 * VIRTIO_BLOCK_SECTOR_BYTES;
const SNAPSHOT_NETWORK_MMDS_FRESH_OFFSET: u64 = 5 * VIRTIO_BLOCK_SECTOR_BYTES;
